...
<body>
    <div class="page-wrapper">
        <div class="container">
            ...
            $query = "SELECT * FROM parking_records WHERE active_status='no'";
            $result = mysqli_query($conn, $query);

            if(mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    // Display details of left vehicles
                ...
                echo "<p class='no-results'>No left vehicles found.</p>";
            }
